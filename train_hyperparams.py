...
# Params
data_folder = '/home/code-base/user_space/Dataset/Self_Constructed_GAN_Render_Image_Pairs'
...
mod_encode = MODULATION_ENCODING[1]
mod_space = MODULATION_SPACE[1]
mod_encoder_layer = 18
w_plus_sliced_layer = list(range(4, 10))
co_mod = CO_MODULATION_MODE[0]
use_tanh = False
ckpt = './Model_Assets/256px_full_size_StyleGAN2.pt'
...
rec_dataset_type = DATASET_TYPE[1]
...
hmap_loss_lambda = 1e-4
hmap_iter_thres = np.inf
face_reg_loss_lambda = 20
...
# Currently Unused Params for G Regularization/Generation
noise_mixing = 0.9

# Currently Unused Params for G Validation
fid_n_sample = 50000
fid_batch = 32
